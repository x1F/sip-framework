...
Version 3.4.0 allows fine-grained configuration and exception handling. This is the main method for handling exception,
adapters should be updated to use it instead of base route configuration from Apache Camel.
