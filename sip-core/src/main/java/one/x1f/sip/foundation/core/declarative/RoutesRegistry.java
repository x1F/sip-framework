...
import static one.x1f.sip.foundation.core.declarative.utils.DeclarativeHelper.isPrimaryEndpoint;
import static one.x1f.sip.foundation.core.util.CamelProcessorsHelper.getEndpointUri;
import static one.x1f.sip.foundation.core.util.CamelProcessorsHelper.isInMemoryUri;

import java.util.*;
import lombok.Synchronized;
import one.x1f.sip.foundation.core.declarative.connector.ConnectorDefinition;
import one.x1f.sip.foundation.core.declarative.dto.EndpointInfo;
