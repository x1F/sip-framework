...
@SpringBootTest(
    ...
    properties = {
      ...
      "sip.core.tracing.logging.connector-extension=true",
      "sip.core.tracing.log=false"
    })
@DirtiesContext
class ConnectorExtensionTracerTest {
  ...
  void setUp() {
    ...
    Logger logger =
        (Logger)
            LoggerFactory.getLogger("one.x1f.sip.foundation.core.trace.ConnectorExtensionTracer");
