...
public class SIPAnnotationProcessor extends AbstractProcessor {
    ...
    private final Map<String, String> expectedParentClasses = Map.of(
            "one.x1f.sip.foundation.core.declarative.annotation.InboundConnector", "one.x1f.sip.foundation.core.declarative.connector.InboundConnectorBase",
            "one.x1f.sip.foundation.core.declarative.annotation.OutboundConnector", "one.x1f.sip.foundation.core.declarative.connector.GenericOutboundConnectorBase",
            "one.x1f.sip.foundation.core.declarative.annotation.IntegrationScenario", "one.x1f.sip.foundation.core.declarative.scenario.IntegrationScenarioBase",
            "one.x1f.sip.foundation.core.declarative.annotation.CompositeProcess", "one.x1f.sip.foundation.core.declarative.process.CompositeProcessBase",
            "one.x1f.sip.foundation.core.declarative.annotation.ConnectorGroup", "one.x1f.sip.foundation.core.declarative.connectorgroup.ConnectorGroupBase"
    );
            ...
            if (element.getKind() == ElementKind.CLASS) {
                ...
                if (!extendsClass(classElement, expectedParent)) {
                    processingEnv.getMessager().printMessage(
                            ...
                            String.format("Class %s annotated with @%s must extend %s",
